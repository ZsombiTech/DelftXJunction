    ...
    <div className="min-h-screen bg-uber-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-uber-gray-400">Reset your password</p>
        </div>

        {/* Forgot Password Form */}
        <div className="bg-uber-white rounded-lg shadow-lg p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-uber-gray-900 mb-2">Forgot password?</h2>
          ...
          <div className="mt-6 text-center">
            <Link to="/login" className="text-sm text-uber-black hover:text-uber-gray-700 font-medium">
              ← Back to sign in
            </Link>
          </div>
        </div>
