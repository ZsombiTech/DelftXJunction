...
class Cities(Model):
    ...
    # Reverse relation to WeatherDaily
    weather: fields.ReverseRelation["WeatherDaily"]
    ...
    # Reverse relation to JobLike (begin)
    jobs_like_begin: fields.ReverseRelation["JobsLike"]
    # Reverse relation to Job
    jobs_like_end: fields.ReverseRelation["JobsLike"]
    # Reverse relation to RidesTrips
    rides_trips: fields.ReverseRelation["RidesTrips"]
    # Reverse relation to CancellationRates
    cancellation_rates: fields.ReverseRelation["CancellationRates"]
