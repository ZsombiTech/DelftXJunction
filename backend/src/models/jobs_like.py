...
class JobsLike(Model):
    ...
    requestor_uuid = fields.ForeignKeyField(
        "models.Riders",
        related_name="jobs_like",
        null=False
    )
    begin_checkpoint_actual_location_hexagon_id_9 = fields.CharField(max_length=50, null=True)
    begin_checkpoint_actual_location_latituede = fields.FloatField(null=True)
    begin_checkpoint_actual_location_longitude = fields.FloatField(null=True)
    begin_checkpoint_actual_city_id = fields.ForeignKeyField(
        "models.Cities",
        related_name="jobs_like_begin",
        null=False
    )
    begin_checkpoint_ata_utc = fields.DatetimeField(null=True)
    end_checkpoint_actual_location_hexagon_id_9 = fields.CharField(max_length=50, null=True)
    end_checkpoint_actual_location_latituede = fields.FloatField(null=True)
    end_checkpoint_actual_location_longitude = fields.FloatField(null=True)
    end_checkpoint_actual_city_id = fields.ForeignKeyField(
        "models.Cities",
